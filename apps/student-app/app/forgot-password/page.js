        ...
        <div className="w-full max-w-md flex flex-col">
          ...
          <div className="mb-6 text-center lg:text-left shrink-0">
            ...
            <p className="mt-2 text-gray-500 font-medium text-sm">
              Step {step} of 3: {step === 1 ? "Identify your account" : step === 2 ? "Check your inbox" : "Set your new credentials"}
            </p>
          </div>
          ...
          <div className="flex-1">
            ...
            {step === 1 && (
              <form onSubmit={handleRequestOtp} className="space-y-4">
                ...
                >
                  {loading ? <Loader2 className="animate-spin h-5 w-5" /> : <>Send Reset Code <ArrowRight size={18} /></>}
                </button>
              </form>
            )}
            ...
            {step === 2 && (
              <form onSubmit={handleVerifyOtp} className="space-y-6">
                <div className="bg-blue-50 rounded-2xl p-4 text-center border border-blue-100 shrink-0">
                  ...
                  <p className="text-xs text-blue-700 mt-1">Reset code sent to {email}</p>
                </div>
                ...
                >
                  {loading ? <Loader2 className="animate-spin h-5 w-5 mx-auto" /> : "Verify Code"}
                </button>
            ...
            {/* STEP 3: NEW PASSWORD WITH CONFIRM */}
            {step === 3 && (
